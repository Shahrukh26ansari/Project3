...
body {
	background-image: url("/ORSProject3/image/"), url("/ORSProject3/image/registration.jpg");
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 col-sm-12 col-lg-4 col-md-offset-4">
					<div class="panel panel-primary"
						style="margin-top: 10px; border-color: #c5cfd8;">
						<div class="panel-heading" 
							align="center">

							<b><h1 style="color: white">User Registration</h1></b>
						...
						<div class="panel-body">
							<div align="center">
								<div class="alert alert-success" role="alert"
									style="width: 90%; margin-left: 0%; font-size: 150%"    box-shadow: 9px 8px 7px #e4e4e4;
    background: rgba(10, 10, 10, 0.44);
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6" style="color: white;">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label col-md-6 text-info"style="color: white;">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label class="control-label col-md-6 text-info" style="color: white;"> Login
		  ...
		  %>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label class="control-label col-md-6 text-info" style="color: white;"> Date
