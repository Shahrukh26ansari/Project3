...
<style type="text/css">
body {
	background-image: url("/ORSProject3/image"), url("/ORSProject3/image/hand.png");
...
<form action="<%=ORSView.WELCOME_CTL%>">
		...
		<h1 align="center">
		<font style="font-size:150%;color:red;" color="red">
		<br><p class="text"><b><i><strong>Welcome To ORS</strong></i></b></p></font>
		</h1>
		</div>
		</div>
		      <%
