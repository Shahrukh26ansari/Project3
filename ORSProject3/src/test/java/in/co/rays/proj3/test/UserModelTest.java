...
public class UserModelTest {
	...
	public static void testAdd() throws ParseException, DuplicateRecordException {
		...
		try {
			...
			bean.setId(2);
			bean.setFirstName("shahrukh");
			bean.setLastName("Ahmed");
			bean.setLogin("Shahrukh26ansari@gmail.com");
			bean.setPassword("Srk@1234");
			bean.setDob(sdf.parse("02-02-2000"));
			bean.setRoleId(1);
	...
	public static void testforgetPassword() {
		try {
			boolean b = model.forgetPassword("shubhanshu126@gmail.com");
